...
const CONTRAST_REQUIREMENTS: ContrastRequirement[] = [
  ...
  { foreground: "positive", background: "positive-surface", minimumRatio: 4.5 },
  { foreground: "negative", background: "surface", minimumRatio: 4.5 },
  { foreground: "negative", background: "negative-surface", minimumRatio: 4.5 },
  { foreground: "warning", background: "surface", minimumRatio: 4.5 },
  { foreground: "warning", background: "warning-surface", minimumRatio: 4.5 },
